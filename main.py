...
from image_transform import get_image_from_bytes
from image_transform import detect_sample_model
from image_transform import add_bboxs_on_img
from image_transform import get_bytes_from_image
...
# title
app = FastAPI(
    title="Road Defects Detection API",
